  ...
  return (
    <SessionProvider>
      <html lang="en" className="relative h-full">
        <body
          className={`${aldrich.variable} ${chivo.variable} relative h-full min-h-full overflow-y-scroll pt-16 antialiased **:transition-colors **:duration-200 *:not-last-of-type:pb-32`}
        >
          {children}
